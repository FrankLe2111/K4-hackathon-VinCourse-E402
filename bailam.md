...
```text
Normalization
    prerequisite_of → Stable gradient descent

Cross entropy
    commonly_confused_with → Mean squared error

Backpropagation
    implemented_by → backward() function in lab_04.py
```
...
{
  "question_id": "q_001",
  "concept_ids": ["normalization", "gradient_descent"],
  "learning_objective": "Explain the effect of feature scale",
  ...
  "common_mistakes": [],
  "source_refs": [],
  "similarity_group": "normalization_effect",
...
Source:
- preprocessing.py::normalize_image
- notebook_02.ipynb cell 14
